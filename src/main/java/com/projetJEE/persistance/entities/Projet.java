...
public class Projet {
    ...
    public Projet(Integer idProjet, Date dateDebProj, Date dateFinProj, String etatProj, String descriptProj, String nomProj, Administrateur administrateur, Equipe equipe, ChefProjet chefProjet, Collection<Tache> tache) {
        this.idProjet = idProjet;
        this.dateDebProj = dateDebProj;
        this.dateFinProj = dateFinProj;
        this.etatProj = etatProj;
